...
head.ready(function () {
    ...
    var idUsuario=0; 
    var catalogoPreguntas:Array<Preguntas>;
    var idPregunta=0;
    var idFactor=0;
    ...
    function Ingresar() {        
        var usr: UsuarioPojo = new UsuarioPojo();
        ...
        post$Usuario$CrearUsuarioProyecto(usr, function (result: Msg) {            
            if (result.status != 'OK')
                return alert('EL usuario o contraseña son incorrectos');
            var validacionLogueo=<UsuarioPojo>result.data;
            if(validacionLogueo!= undefined && validacionLogueo.id!=0){
                ...
                $('#btn_Finalizar').hide();
                 ...
                 get$Preguntas$BuscarPreguntas(function (result: Msg) {  
                        catalogoPreguntas =<Array<Preguntas>> result.data;  
   ...
   //funcion  que graba los datos de la pregunta y ademas carga una nueva pregunta   
    $('#btn_Siguiente').click(function () {
        ...
        var respuesta: CalificacionFactorPojo =new CalificacionFactorPojo();
        ...
        post$RegistroDatos$RegistrarPregunta(respuesta,function (result: Msg) { 
            var almacenamiento = <boolean>result.data;
            if(almacenamiento){
    ...
    $('#btn_Finalizar').click(function () {
       ...
       var respuesta: CalificacionFactorPojo =new CalificacionFactorPojo();
        ...
        post$RegistroDatos$RegistrarPregunta(respuesta,function (result: Msg) { 
            ...
            get$RegistroDatos$ProcesarArquitectura(idUsuario,function (result: Msg) { 
                    
                    //llamamos al servicio para traer la informacion
                get$RegistroDatos$leerCalificacionArquitectura(idUsuario,function (result: Msg) {
                        var respuesta =<RespuestaGeneralPojo>result.data;
                        ...
                        for(let valor of respuesta.factor){
