...
var modulos:Array<modularidad>= new Array<modularidad>();
...
head.ready(function () {
  ...
  //regresar a pregunta 4
    ...
    var modulosIndividuales= new Array<factorDetalle>();
  ...
  //Confirmar modulos
    ...
    modulos= new Array<modularidad>();
    var listasFinal;
    var factorTodos = new Array<factor>();
    var listadoValores = new Array<number>();
    var listadoValoresMinimos = new Array<number>();
    var listadoValoresNombres = new Array<string>();
...
//         });
    ...
    $('#AgregarModuloLista').click(function () {
        ...
        for(let modulo of modulosIndividuales ){
    ...
    function editarModulo(id:number){
        idEditar=id;
        $("#ventanaAgregarModulos").kendoWindow({
            width: "500px",
            height: "600px",
